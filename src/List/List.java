...
/**
 * 자바 List.List Interface입니다. <br> List는 List.ArrayList, List.SinglyLinkedList, DoublyLinkedList에 의해
 * 각각 구현됩니다. *
 *
...
public interface List<E> {
     ...
     * @return 리스트에서 중복을 허용하지 않을 경우에 리스트에 이미 중복되는 요소가 있을 경우 {@code false}를 반환하고, 중복되는 원소가 없을경우
     * {@code true}를 반환
     */
    boolean add(E value);

    /**
     * 리스트에 요소를 특정 위치에 추가합니다. 특정 위치 및 이후의 요소들은 한 칸씩 뒤로 밀립니다.
     *
